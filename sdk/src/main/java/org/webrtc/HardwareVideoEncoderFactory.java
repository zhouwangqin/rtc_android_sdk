...
// add by zhouwq
import static org.webrtc.MediaCodecUtils.VP8_PREFIX;
import static org.webrtc.MediaCodecUtils.H264_PREFIX;
// add end
...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
  ...
  private boolean isHardwareSupportedInCurrentSdkVp8(MediaCodecInfo info) {
    ...
    return (name.startsWith(QCOM_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
        ...
        || (name.startsWith(INTEL_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && enableIntelVp8Encoder)
		
		// add by zhouwq
        || (name.startsWith(VP8_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT);
        // add end
  }
  ...
  private boolean isHardwareSupportedInCurrentSdkH264(MediaCodecInfo info) {
    ...
    return (name.startsWith(QCOM_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
		...
		// add by zhouwq
        || (name.startsWith(H264_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT);
        // add end
  }
