...
public class AppRTCBluetoothManager {
  ...
  protected void registerReceiver(BroadcastReceiver receiver, IntentFilter filter) {
    try {
      Log.d(TAG, "AppRTCAudioManager.........registerReceiver..bluetoothHeadsetReceiver..00 = " + receiver + " == " + apprtcContext);
      apprtcContext.registerReceiver(receiver, filter);
      Log.d(TAG, "AppRTCAudioManager.........registerReceiver..bluetoothHeadsetReceiver..11 = ");
    }catch (Exception e){
      Log.d(TAG, "AppRTCAudioManager.........registerReceiver..bluetoothHeadsetReceiver.. = " + e.toString());
    }
  }

  protected void unregisterReceiver(BroadcastReceiver receiver) {
    try {
      Log.d(TAG, "AppRTCAudioManager.........unregisterReceiver..bluetoothHeadsetReceiver..00 = " + receiver + " == " + apprtcContext);
      apprtcContext.unregisterReceiver(receiver);
      Log.d(TAG, "AppRTCAudioManager.........unregisterReceiver..bluetoothHeadsetReceiver..11 = ");
    }catch (Exception e){
      Log.d(TAG, "AppRTCAudioManager.........unregisterReceiver..bluetoothHeadsetReceiver = " + e.toString());
    }
  }
